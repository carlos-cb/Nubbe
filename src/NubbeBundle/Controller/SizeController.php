...
use NubbeBundle\Entity\Size;
use NubbeBundle\Entity\Product;
use NubbeBundle\Form\SizeType;
...
class SizeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $sizes = $em->getRepository('NubbeBundle:Size')->findAll();
    ...
    {
        $size = new Size();
        $form = $this->createForm('NubbeBundle\Form\SizeType', $size);
    ...
    {
        $deleteForm = $this->createDeleteForm($size);
        $editForm = $this->createForm('NubbeBundle\Form\SizeType', $size);
