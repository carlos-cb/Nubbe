...
use NubbeBundle\Entity\Color;
use NubbeBundle\Entity\Product;
use NubbeBundle\Form\ColorType;
...
class ColorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $colors = $em->getRepository('NubbeBundle:Color')->findAll();
    ...
    public function newAction(Request $request, Product $product)
    {
        ...
        $form = $this->createForm('NubbeBundle\Form\ColorType', $color);
    ...
    public function editAction(Request $request, Color $color, Product $product)
    {
        ...
        $deleteForm = $this->createDeleteForm($color);
        $editForm = $this->createForm('NubbeBundle\Form\ColorType', $color);
    ...
    public function removeAction(Color $color)
    {
        ...
        foreach ($fotodetalles as $fotodetalle)
        {
            ...
            if($fileF){
                $isRemoved = $this->get('nubbe.foto_uploader')->remove($fileF);
            }
