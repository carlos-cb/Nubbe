...
use NubbeBundle\Form\ProductType;
...
class ProductController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $products = $em->getRepository('NubbeBundle:Product')->findAll();
    ...
    {
        $product = new Product();
        $form = $this->createForm('NubbeBundle\Form\ProductType', $product);
    ...
    public function showAction(Product $product)
    {
        ...
        //获取细节图
        $queryp = $em->createQuery("SELECT p FROM NubbeBundle:Fotodetalle p WHERE p.product=$product order by p.color");
        $fotodetalles = $queryp->getResult();

        //尺码
        $queryt = $em->createQuery("SELECT t FROM NubbeBundle:Size t WHERE t.product=$product");
        $sizes = $queryt->getResult();

        //颜色
        $queryh = $em->createQuery("SELECT h FROM NubbeBundle:Color h WHERE h.product=$product");
    ...
    public function editAction(Request $request, Product $product)
    {
        ...
        $deleteForm = $this->createDeleteForm($product);
        $editForm = $this->createForm('NubbeBundle\Form\ProductType', $product);
