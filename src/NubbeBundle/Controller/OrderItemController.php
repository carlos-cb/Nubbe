...
use NubbeBundle\Form\OrderItemType;
...
class OrderItemController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $orderItems = $em->getRepository('NubbeBundle:OrderItem')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('NubbeBundle\Form\OrderItemType', $orderItem);
    ...
    {
        $deleteForm = $this->createDeleteForm($orderItem);
        $editForm = $this->createForm('NubbeBundle\Form\OrderItemType', $orderItem);
