...
use NubbeBundle\Form\OrderInfoType;
...
class OrderInfoController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('NubbeBundle\Form\OrderInfoType', $orderInfo);
    ...
    {
        $deleteForm = $this->createDeleteForm($orderInfo);
        $editForm = $this->createForm('NubbeBundle\Form\OrderInfoType', $orderInfo);
