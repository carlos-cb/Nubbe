...
class Category
{
     ...
     * Add products
     *
     * @param \NubbeBundle\Entity\Product $products
     * @return Category
     */
    public function addProduct(\NubbeBundle\Entity\Product $products)
    {
     ...
     * @param \NubbeBundle\Entity\Product $products
     */
    public function removeProduct(\NubbeBundle\Entity\Product $products)
    {
