...
class Fotodetalle
{
     ...
     * Set color
     *
     * @param \NubbeBundle\Entity\Color $color
     * @return Fotodetalle
     */
    public function setColor(\NubbeBundle\Entity\Color $color = null)
    {
        $this->color = $color;
     ...
     * Get color
     *
     * @return \NubbeBundle\Entity\Color 
     */
